...
const GitHubGraph = () => {
    ...
    return (
        <div className="github-graph-container">
            ...
            <div id="no-scrollbar-container" className="bg-zinc-900/5 p-10 rounded-2xl border border-white/10 backdrop-blur shadow-2xl overflow-x-auto transition-all duration-500">
                <GitHubCalendar
                    username="GregoJaca"
                    colorScheme='dark'
                    theme={theme}
